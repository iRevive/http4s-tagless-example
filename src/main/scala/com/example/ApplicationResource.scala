...
import com.example.persistence.{PersistenceModule, PersistenceModuleResource}
import com.example.service.{ServiceModule, ServiceModuleResource}
import com.example.util.api._
